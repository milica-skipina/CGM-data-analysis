...
print("-------------------- CGM VS BGM --------------------")
cgm_vs_bgm = cgm_vs_bgm.withColumn("DiffInSeconds", abs(col("DateTimeBGM").cast(LongType()) - col("DateTime").cast(LongType())))\
...
cgm_vs_bgm.orderBy("GlucoseValueDiff").groupBy("GlucoseValueDiff").count().show(250)
